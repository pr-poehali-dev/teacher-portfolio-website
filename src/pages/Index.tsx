        ...
        <div className="container mx-auto">
          <Card className="border-0 shadow-xl animate-fade-in">
            ...
            <CardContent className="space-y-6 text-lg">
              <p>
                Я окончила Московский государственный педагогический университет с красным дипломом по
                специальности "Филология". Моя преподавательская карьера началась в 2009 году, и с тех
                пор я не перестаю восхищаться богатством русского языка и литературы.
              </p>
              <p>
                За годы работы я подготовила более 200 учеников к успешной сдаче ЕГЭ и ОГЭ. Мои ученики
                становились призёрами и победителями всероссийских олимпиад, а их литературные работы
                публиковались в престижных журналах.
              </p>
              <p>
                Я считаю, что каждый ребёнок уникален, и моя задача – найти подход, который раскроет его
                потенциал. Использую современные методики обучения, интерактивные технологии и всегда
                стремлюсь сделать уроки увлекательными и запоминающимися.
              </p>
